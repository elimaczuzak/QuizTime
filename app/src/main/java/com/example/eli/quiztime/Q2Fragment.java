 ...
 * {@link Q2Fragment.OnFragmentInteractionListener} interface
        ...
        q2_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txt.equalsIgnoreCase("")){
                    ...
                    if (txt.equalsIgnoreCase("Charizard") || txt.equalsIgnoreCase("charizard") || txt.equalsIgnoreCase("CHARIZARD")) {
                        QuizActivity.count++;
                    }
